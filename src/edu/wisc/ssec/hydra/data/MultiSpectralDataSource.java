...
import edu.wisc.ssec.adapter.AIRS_L1B_Spectrum;
import edu.wisc.ssec.adapter.AMSA_L1_NCDF_RangeProcessor;
import edu.wisc.ssec.adapter.AMSA_xxx_L1_RangeProcessor;
...
import edu.wisc.ssec.adapter.HIRS_xxx_L1_RangeProcessor;
import edu.wisc.ssec.adapter.IASI_L1C_AAPP_Spectrum;
import edu.wisc.ssec.adapter.IASI_L1C_AAPP_SwathAdapter;
import edu.wisc.ssec.adapter.IASI_L1C_NCDF_Spectrum;
import edu.wisc.ssec.adapter.IASI_L1C_Spectrum;
import edu.wisc.ssec.adapter.IASI_L1C_SwathAdapter;
import edu.wisc.ssec.adapter.LambertAEA;
import edu.wisc.ssec.adapter.LongitudeLatitudeCoordinateSystem;
import edu.wisc.ssec.adapter.MERSI_L1B_Emis_RangeProcessor;
import edu.wisc.ssec.adapter.MERSI_L1B_Refl_RangeProcessor;
import edu.wisc.ssec.adapter.MHS_L1C_AAPP_RangeProcessor;
import edu.wisc.ssec.adapter.MHS_L1_NCDF_RangeProcessor;
import edu.wisc.ssec.adapter.MHS_xxx_L1_RangeProcessor;
...
public class MultiSpectralDataSource extends DataSource {
    ...
    public MultiSpectralDataSource(String fileName) throws VisADException {
      this(Misc.newList(fileName));
    }

    public MultiSpectralDataSource(List sources) throws VisADException {
