...
public class AIRSv1_SoundingDataSource extends AtmSoundingDataSource {


   public AIRSv1_SoundingDataSource(File directory) {
     this(directory.listFiles());
   }

   public AIRSv1_SoundingDataSource(File[] files) {
      super(files);
   }
   ...
   void init(File file) throws Exception {
      ...
      SwathSoundingData dataTA = buildAdapter(reader, "fakeDim9", "fakeDim8", "fakeDim10", "vertPressLevel", vals, "TAirStd", "Temperature", "fakeDim3", "fakeDim2",
      ...
      SwathSoundingData dataWV = buildAdapter(reader, "fakeDim14", "fakeDim13", "fakeDim15", "vertPressLevel", vals, "H2OMMRStd", "WV", "fakeDim3", "fakeDim2",
                                   "Longitude", "Latitude", null, new String[] {"fakeDim2", "fakeDim3"}, new String[] {"fakeDim0", "fakeDim1"}, null);
      ...
      SwathSoundingData dataO3 = buildAdapter(reader, "fakeDim19", "fakeDim18", "fakeDim20", "vertPressLevel", vals, "O3VMRStd", "O3", "fakeDim3", "fakeDim2",
                                   "Longitude", "Latitude", null, new String[] {"fakeDim2", "fakeDim3"}, new String[] {"fakeDim0", "fakeDim1"}, null);
