...
public class ImageDisplay extends HydraDisplay implements ActionListener, ControlListener {
   ...
   public ImageDisplay(DisplayableData imageDsp, MapProjection mapProj, int windowNumber, boolean createFrame)
      ...
      if (addProbe) {
         ...
         minMarker.doMakeProbe(Color.red, dspMaster, baseScale, scale, false, "CROSS", 0.8f, 1.4f, Color.green);
         minMarker.setFixed();
         ...
         maxMarker.doMakeProbe(Color.red, dspMaster, baseScale, scale, false, "CROSS", 0.8f, 1.4f, Color.yellow);
         maxMarker.setFixed();
      }
