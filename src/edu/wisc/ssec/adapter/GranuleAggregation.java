...
public class GranuleAggregation implements MultiDimensionReader {
   ...
   private synchronized Object readArray(String array_name, int[] start, int[] count, int[] stride, Object obj) throws Exception {
	   ...
	   for (Array a : arrayList) {
		   if (a != null) {
			   ...
			   primArray = processArray(array_name, arrayType, granIdx, primArray, rngProcessor, obj);
   ...
   private Object processArray(String array_name, Class arrayType, int granIdx, Object values, RangeProcessor rngProcessor, Object obj) {
   ...
   public RangeProcessor getRangeProcessor(String arrayName) {
