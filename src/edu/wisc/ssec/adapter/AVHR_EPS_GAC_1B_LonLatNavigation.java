...
public class AVHR_EPS_GAC_1B_LonLatNavigation extends SwathNavigation  {


  public AVHR_EPS_GAC_1B_LonLatNavigation(SwathAdapter swathAdapter) throws Exception {
    super(swathAdapter);
  }
